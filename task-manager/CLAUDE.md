...
This app lives in `task-manager/` inside the `productivity` git repository.
Run app commands from this directory. Git commands can be run from here or from the repo root.
